<template>
	<div>
		<FastTable table-key="1D11DZCT3N" row-key="recordId" :request-api="sqlTimeoutLogApi.querySqlTimeoutLogPaged">
...
import type { SqlTimeoutLogModel } from "@/api/services/Center/sqlTimeoutLog/models/SqlTimeoutLogModel";
