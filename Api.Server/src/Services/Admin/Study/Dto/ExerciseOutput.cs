...
/// <summary>
/// <see cref="ExerciseOutput"/> 练习题目输出
/// </summary>
public class ExerciseOutput
{
    ...
    public List<ExerciseOptionOutput> Options { get; set; }
}

/// <summary>
/// <see cref="ExerciseOptionOutput"/> 练习选项输出
/// </summary>
public class ExerciseOptionOutput
{
    /// <summary>题目选项Id</summary>
