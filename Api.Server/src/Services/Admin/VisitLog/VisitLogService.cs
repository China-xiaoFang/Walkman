...
using Fast.Admin.Service.VisitLog.Dto;
using Fast.AdminLog.Entity;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace Fast.Admin.Service.VisitLog;
...
public class VisitLogService : IDynamicApplication
{
    ...
    /// <returns></returns>
    [HttpPost]
    [ApiInfo("删除90天前的访问日志", HttpRequestActionEnum.Delete)]
    public async Task DeleteVisitLog()
    {
