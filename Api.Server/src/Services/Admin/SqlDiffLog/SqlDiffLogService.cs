...
using Fast.Admin.Service.SqlDiffLog.Dto;
using Fast.AdminLog.Entity;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace Fast.Admin.Service.SqlDiffLog;
...
public class SqlDiffLogService : IDynamicApplication
{
    ...
    public async Task<PagedResult<SqlDiffLogModel>> QuerySqlDiffLogPaged(QuerySqlDiffLogPagedInput input)
    {
        ...
        return await _repository.Entities.WhereIF(input.AccountId != null, wh => wh.AccountId == input.AccountId)
    ...
    /// <returns></returns>
    [HttpPost]
    [ApiInfo("删除90天前的Sql差异日志", HttpRequestActionEnum.Delete)]
    public async Task DeleteSqlDiffLog()
    {
