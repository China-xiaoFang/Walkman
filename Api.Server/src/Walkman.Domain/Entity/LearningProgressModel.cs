...
/// 学习进度表Model类
/// </summary>
[SugarTable("PlayProgress", "学习进度表")]
[SugarDbType(DatabaseTypeEnum.Admin)]
[SugarIndex($"IX_{{table}}_{nameof(UserId)}_{nameof(LessonId)}_{nameof(AudioType)}", nameof(UserId), OrderByType.Asc,
    nameof(LessonId), OrderByType.Asc, nameof(AudioType), OrderByType.Asc, true)]
public class LearningProgressModel : IUpdateVersion
{
    /// <summary>
    /// 记录Id
    /// </summary>
    ...
    /// 播放进度
    /// </summary>
    [SugarColumn(ColumnDescription = "播放进度")]
