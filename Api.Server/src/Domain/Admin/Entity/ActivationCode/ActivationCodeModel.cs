...
/// <summary>
/// <see cref="ActivationCodeModel"/> 激活码表Model类
/// </summary>
[SugarTable("ActivationCode", "激活码表")]
[SugarDbType(DatabaseTypeEnum.Admin)]
[SugarIndex($"IX_{{table}}_{nameof(Code)}", nameof(Code), OrderByType.Asc, true)]
[SugarIndex($"IX_{{table}}_{nameof(TextbookId)}", nameof(TextbookId), OrderByType.Asc)]
public class ActivationCodeModel : BaseEntity, IUpdateVersion
{
    /// <summary>
    /// 激活码Id
    /// </summary>
    ...
    /// 绑定用户Id
    /// </summary>
    [SugarColumn(ColumnDescription = "绑定用户Id", IsNullable = true)]
